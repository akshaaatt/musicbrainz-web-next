            ...
            <div className="container">
                <div className="row">
                    <div className="col-sm-12 col-md-4">
                        <p className="image-container navbar-brand text-brand">
                        ...
                        <ul className="list-unstyled">
                            <li className="color-a">
                                ...
                                <a href="https://kiwiirc.com/nextclient/irc.libera.chat/?#metabrainz"
                                   target="_blank"
                ...
                <div className="row center-p">
                    ...
                    <div className="col-md-6">
                        <p className="section-line image-container copyright ">
                            Brought to you by
                            <div className='image'>
                                <Image src="/assets/img/meb-icons/MetaBrainz.svg"
                                       width="24"
                                       height="24"
                                       alt="image"/>
                            </div>
