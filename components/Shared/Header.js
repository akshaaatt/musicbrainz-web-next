...
const changeIcon = () =>{
  ...
  if(query.value.length <= 1){
    search_button.innerHTML = "Advance Search"
  }
  else{
    search_button.innerHTML = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" className="bi bi-search" viewBox="0 0 16 16">
